...
data = dict(
    ...
    val=dict(
        type='CocoDataset',
        ann_file= './data/rvc/annotations/mvd_boxable.rvc_val.json',
        img_prefix='./data/rvc/annotations/',
        classes=CLASSES,
...
checkpoint_config = dict(interval=4, max_keep_ckpts=20, save_last=True)
fp16 = dict(loss_scale=512.)

load_from = "./work_dirs/cascade_rcnn_nasfpn_crpn_32gf_1x_rvc/epoch_8.pth"